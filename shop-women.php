...
require_once("src/read_specific.php");
...
<div class="container py-5">
    <div class="row">
            ...
            <ul class="list-unstyled templatemo-accordion">
                ...
                <li class="pb-3">
                    ...
                    <ul id="collapseThree" class="collapse list-unstyled pl-3">
                        <li><a class="text-decoration-none" href="shop-dresss.php">dresss</a></li>
        ...
        <div class="col-lg-9">
            <div class="row">
                <div class="col-md-6">
                    <ul class="list-inline shop-top-menu pb-3 pt-1">
                        ...
                        <li class="list-inline-item">
                            <p class="h3 text-dark text-decoration-none mr-3">Women's</p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row">
                <?php
                // Fetch specific products based on gender
                $result = get_specific('product', 'gender', 'women');
                while ($product = mysqli_fetch_assoc($result)):
                    if ($product["id"] >= 4):
                        // Fetch category name if the category_id is valid
