...
<?php $config["root_path"] . require_once("inc/header.php"); // Include the header file ?>
<?php $config["root_path"] . require_once("inc/nav.php"); // Include the navigation file ?>
...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-lg-9">
            ...
            <div class="row">
                <?php $result = get_specific('product', 'category_id', 14); // Fetch products based on category ID ?>
                        ...
                        <div class="carousel slide carousel-multi-item pt-2 pt-md-0" id="templatemo-slide-brand" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <?php $result = get_all('brands'); // Fetch all brands ?>
                                        <?php while($brand = mysqli_fetch_assoc($result)): ?>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="<?php echo $config["base_url"] . "public/images/brands/" . $brand["image"]; ?>" alt="Brand Logo"></a>
                                        </div>
                                        <?php endwhile; ?>
                                    </div>
                                </div>
...
<?php $config["root_path"] . require_once("inc/footer.php"); // Include the footer file ?>
